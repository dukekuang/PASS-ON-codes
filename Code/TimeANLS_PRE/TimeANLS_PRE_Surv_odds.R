...
Riaz.res$SS <- prob2odds(TA_PRE_ss$Riaz)
...
tiff(file="output/TimeANLS_PRE/Riaz_TimeANLS_PRE_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
tiff(file="output/TimeANLS_PRE/Riaz_TimwANLS_PRE_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
Gide.res$SS <- prob2odds(TA_PRE_ss$Gide)
...
tiff(file="output/TimeANLS_PRE/Gide_TimeANLS_PRE_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(Gide.OS.fit,
           ...
           risk.table.y.text = TRUE,
           risk.table.y.text.col = TRUE,
           legend.labs = c("High (n=24)", "Low (n=48)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
...
tiff(file="output/TimeANLS_PRE/Gide_PASS_PRE_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
Lee.res$SS <- prob2odds(TA_PRE_ss$Lee)
...
tiff(file="output/TimeANLS_PRE/Lee_TimeANLS_PRE_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(Lee.OS.fit,
           ...
           risk.table.y.text = TRUE,
           risk.table.y.text.col = TRUE,
           legend.labs = c("High (n=15)", "Low (n=28)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
...
MGH.res$SS <- prob2odds(TA_PRE_ss$MGH)
...
tiff(file="output/TimeANLS_PRE/MGH_TimeANLS_PRE_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(MGH.OS.fit,
           ...
           risk.table.y.text = TRUE,
           risk.table.y.text.col = TRUE,
           legend.labs = c("High (n=8)", "Low (n=11)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
...
tiff(file="output/TimeANLS_PRE/MGH_TimeANLS_PRE_PFS_odds_mean.tiff", width=7, height=5, unit='in',compression = 'lzw',res=150)
...
tiff(file="output/TimeANLS_PRE/All_Test_Sample_PASS_PRE_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(all.test.Sample.OS.fit,
           ...
           risk.table.y.text.col = TRUE,
           #conf.int = TRUE,
           legend.labs = c("High (n=47)", "Low (n=87)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
...
tiff(file="output/TimeANLS_PRE/All_Test_Sample_PASS_PRE_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(all.test.sample.PFS.fit,
           ...
           risk.table.y.text.col = TRUE,
           #conf.int = TRUE,
           legend.labs = c("High (n=32)", "Low (n=59)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
