...
Riaz.res$SS <- prob2odds(TA_ON_ss$Riaz)
...
tiff(file="output/TimeANLS_ON/Riaz_TimeANLS_ON_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(Riaz.OS.fit,
           ...
           legend.labs = c("High (n=21)", "Low (n=27)"),
...
tiff(file="output/TimeANLS_ON/Riaz_TimeANLS_ON_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
Gide.res$SS <- prob2odds(TA_ON_ss$Gide)
...
tiff(file="output/TimeANLS_ON/Gide_TimeANLS_ON_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
tiff(file="output/TimeANLS_ON/Gide_TimeANLS_ON_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
Lee.res$SS <- prob2odds(TA_ON_ss$Lee)
...
tiff(file="output/TimeANLS_ON/Lee_TimeANLS_ON_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(Lee.OS.fit,
           ...
           risk.table.y.text = TRUE,
           risk.table.y.text.col = TRUE,
           legend.labs = c("High (n=9)", "Low (n=14)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
...
MGH.res$SS <- prob2odds(TA_ON_ss$MGH)
...
tiff(file="output/TimeANLS_ON/MGH_TimeANLS_ON_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
ggsurvplot(MGH.OS.fit,
           ...
           risk.table.y.text = TRUE,
           risk.table.y.text.col = TRUE,
           legend.labs = c("High (n=7)", "Low (n=8)"),
           legend.title = 'Signature Score',
           ggtheme = theme_bw(), # Change ggplot2 theme
           tables.theme = theme_void(),
           palette = c("#E31A1C","#1F78B4"),
...
tiff(file="output/TimeANLS_ON/MGH_TimeANLS_ON_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
tiff(file="output/TimeANLS_ON/All_Test_Sample_TimeANLS_ON_OS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
...
tiff(file="output/TimeANLS_ON/All_Test_Sample_TimeANLS_ON_PFS_odds_mean.tiff",width=7, height=5,unit='in',compression = 'lzw',res=150)
